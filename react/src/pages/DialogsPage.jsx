            ...
            <Link data-easytag="id9-react/src/pages/DialogsPage.jsx" to={`/chat/${dlg.id}`} className="flex items-start gap-3 p-3">
              ...
              <div data-easytag="id11-react/src/pages/DialogsPage.jsx" className="flex-1 min-w-0">
                <div data-easytag="id12-react/src/pages/DialogsPage.jsx" className="flex items-center justify-between">
                  <div data-easytag="id13-react/src/pages/DialogsPage.jsx" className="font-medium truncate">{dlg.participant?.first_name ? `${dlg.participant.first_name} ${dlg.participant.last_name || ''}`.trim() : dlg.participant?.phone}</div>
                ...
                <div data-easytag="id15-react/src/pages/DialogsPage.jsx" className="text-sm text-muted truncate">{dlg.last_message ? dlg.last_message.ciphertext : 'Без сообщений'}</div>
              </div>
            </Link>
          </li>
        ))}
